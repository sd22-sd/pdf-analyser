...
st.set_page_config(
    page_title="AI Medical PDF Analyzer",
    page_icon="🧠",
    layout="centered"
)
...
st.markdown('<div class="title">🧠 AI Medical PDF Analyzer</div>', unsafe_allow_html=True)
st.markdown('<div class="subtitle">Smart PDF → OCR → Medical Page Detection System</div>', unsafe_allow_html=True)
...
if st.session_state.images_done:
    ...
    if st.button("🧠 Get Medical Images"):
